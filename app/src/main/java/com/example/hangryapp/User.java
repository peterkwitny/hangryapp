...
public class User {
    ...
    public HashMap<String, Meal> savedmeals;
    ...
    public User(String email, String password, Boolean vegan, Boolean glutenfree, Boolean vegetarian, Boolean dairyfree, Boolean nutfree, HashMap<String, Meal> savedmeals, double priceMax, String pref1, String pref2) {
        this.email = email;
